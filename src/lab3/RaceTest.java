...
public class RaceTest {
	...
	public static void main(String[] args) {
		...
		Car sherriCar = new Car("Sherri", 0, 85, 0.0);
		Car labPartnerCar = new Car("Lab Partner", 0, 100, 0.0);
		Car yourCar = new Car("Kolton's Car", 0, 100, 0.0);
        ...
        System.out.println("_______________________");
			...
			Car anotherCar = new Car("Santa", 0, 100, 0.0);
